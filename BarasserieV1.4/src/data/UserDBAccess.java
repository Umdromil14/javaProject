...
public class UserDBAccess implements UserDataAccess {
    ...
    private LocalityDBAccess localityDBAccess;
    public UserDBAccess(){
        localityDBAccess = new LocalityDBAccess();
    }
    ...
    public void delete(User user) throws SQLException {
        ...
        if (!userHasDocument(user.getId())){
            deleteEmail(user.getId());
            deleteUser(user.getId());
            deleteWorkflow(user.getId());
            localityDBAccess.deleteAddress(user.getIdAddress());
            Utils.popUp("user deleted");
        }
        else{
            Utils.popUp("You can't delete this user because he has documents");
        }
    }
    ...
    public void deleteUser(Integer clientId) throws SQLException
    {
        String query = new StringBuilder()
    ...
    public void deleteWorkflow (Integer clientId) throws SQLException
    {
        String query = new StringBuilder()
